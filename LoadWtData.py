...
print __doc__
path = ('C:\Users\charles\Samsung Link\charles@westrc.com'
        '\Pictures\Auto Upload\*\*.jpg' )  #os.getcwd()
...
while (rawchar == 'c'):
    ...
    fds =  f.find(r'Upload')           +17      # for Auto Upload   directory
    t =    (      f[fds+1:fds+5]   + '-'       # \yyyy      
                + f[fds+5:fds+7]   + '-'       # mon
                + f[fds+7:fds+9]   + ' '       # dd
                + f[fds+10:fds+12] + ':'       # hr
                + f[fds+12:fds+14]             # mm
